...
// Define propTypes for YouTubeIcon component
...
// Define propTypes for AppleMusicIcon component
AppleMusicIcon.propTypes = {
  url: PropTypes.string, // Add url prop type
};
...
// Define propTypes for SpotifyIcon component
...
const PlaylistIcons = ({ url }) => {
  ...
  // Define propTypes for PlaylistIcons component
